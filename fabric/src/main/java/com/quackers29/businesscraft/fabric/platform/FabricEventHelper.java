 ...
 * Note: @Override annotations are omitted because EventHelper interface from
 * common module
 * is only available at runtime via JAR, not at compile time. Methods still
 * implement the interface correctly at runtime.
 */
public class FabricEventHelper implements EventHelper {
    ...
    public void setActiveTownBlock(BlockPos pos) {
