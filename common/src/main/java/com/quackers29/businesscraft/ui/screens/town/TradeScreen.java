...
public class TradeScreen extends AbstractContainerScreen<TradeMenu> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation("businesscraft",
            "textures/gui/trade_screen.png");
    ...
    private void returnToMainUI() {
        ...
        // Pass the town block position from the menu to ensure we maintain the town
        // reference
    ...
    /**
     * Sets an item in the output slot after a trade has been processed on the
     * server
     */
