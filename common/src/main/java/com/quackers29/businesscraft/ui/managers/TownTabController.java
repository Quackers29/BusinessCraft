...
import com.quackers29.businesscraft.ui.tabs.ProductionTab;
import com.quackers29.businesscraft.ui.tabs.SettingsTab;
import net.minecraft.client.gui.components.Button;
import net.minecraft.network.chat.Component;

/**
 * Manages tab creation, life cycle, and configuration for the Town Interface.
...
public class TownTabController {
    ...
    private void createAllTabs() {
        ...
        createProductionTab(contentProvider, tabWidth, tabHeight);
    ...
    /**
     * Creates and configures the Production tab.
     */
    private void createProductionTab(TownInterfaceScreen contentProvider, int width, int height) {
        productionTab = new ProductionTab(contentProvider, width, height);
        createTab("production", "Production", productionTab);
    }
    ...
    public void forceRefreshAllTabs() {
        ...
        // Refresh production tab
        if (productionTab != null && productionTab instanceof ProductionTab) {
            ((ProductionTab) productionTab).update();
        }
