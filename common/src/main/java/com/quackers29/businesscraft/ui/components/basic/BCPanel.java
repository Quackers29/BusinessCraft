...
import com.quackers29.businesscraft.ui.layout.BCLayout;
...
public class BCPanel extends BCComponent {
    ...
    protected void renderContent(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        if (scrollable && maxScrollOffset > 0) {
            ...
            int scrollbarY = y + padding
                    + (int) ((float) scrollOffset / maxScrollOffset * (getInnerHeight() - scrollbarHeight));
     ...
     * @param x2 Ending X coordinate
     * @param y2 Ending Y coordinate
     * @return A new BCPanel instance positioned between the two points with theme
     *         styling
     */
    public static BCPanel createBetweenPoints(int x1, int y1, int x2, int y2) {
