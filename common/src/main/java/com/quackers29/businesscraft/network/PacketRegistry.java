...
public class PacketRegistry {
    ...
    private static void registerPackets() {
        ...
        register(ToggleTouristSpawningPacket.class, "toggle_tourist_spawning_packet", NetworkDirection.PLAY_TO_SERVER,
        ...
        register(SetSearchRadiusPacket.class, "set_search_radius_packet", NetworkDirection.PLAY_TO_SERVER,
                SetSearchRadiusPacket::new, SetSearchRadiusPacket::toBytes, SetSearchRadiusPacket::handle);

        register(SetPathCreationModePacket.class, "set_path_creation_mode_packet", NetworkDirection.PLAY_TO_SERVER,
        ...
        register(DeletePlatformPacket.class, "delete_platform_packet", NetworkDirection.PLAY_TO_SERVER,
                DeletePlatformPacket::decode, DeletePlatformPacket::encode, DeletePlatformPacket::handle);

        register(SetPlatformEnabledPacket.class, "set_platform_enabled_packet", NetworkDirection.PLAY_TO_SERVER,
                SetPlatformEnabledPacket::decode, SetPlatformEnabledPacket::encode, SetPlatformEnabledPacket::handle);

        register(SetPlatformPathPacket.class, "set_platform_path_packet", NetworkDirection.PLAY_TO_SERVER,
                SetPlatformPathPacket::decode, SetPlatformPathPacket::encode, SetPlatformPathPacket::handle);

        register(ResetPlatformPathPacket.class, "reset_platform_path_packet", NetworkDirection.PLAY_TO_SERVER,
                ResetPlatformPathPacket::decode, ResetPlatformPathPacket::encode, ResetPlatformPathPacket::handle);
        ...
        register(SetPlatformDestinationPacket.class, "set_platform_destination_packet", NetworkDirection.PLAY_TO_SERVER,
        ...
        register(OpenDestinationsUIPacket.class, "open_destinations_uipacket", NetworkDirection.PLAY_TO_SERVER,
                OpenDestinationsUIPacket::decode, OpenDestinationsUIPacket::encode, OpenDestinationsUIPacket::handle);
        ...
        register(BoundarySyncRequestPacket.class, "boundary_sync_request_packet", NetworkDirection.PLAY_TO_SERVER,
        ...
        register(OpenTownInterfacePacket.class, "open_town_interface_packet", NetworkDirection.PLAY_TO_SERVER,
                OpenTownInterfacePacket::decode, OpenTownInterfacePacket::encode, OpenTownInterfacePacket::handle);

        register(OpenPaymentBoardPacket.class, "open_payment_board_packet", NetworkDirection.PLAY_TO_SERVER,
                OpenPaymentBoardPacket::decode, OpenPaymentBoardPacket::encode, OpenPaymentBoardPacket::handle);

        register(RequestTownMapDataPacket.class, "request_town_map_data_packet", NetworkDirection.PLAY_TO_SERVER,
                RequestTownMapDataPacket::decode, RequestTownMapDataPacket::encode, RequestTownMapDataPacket::handle);
        ...
        register(CommunalStoragePacket.class, "communal_storage_packet", NetworkDirection.PLAY_TO_SERVER,
                CommunalStoragePacket::decode, CommunalStoragePacket::encode, CommunalStoragePacket::handle);

        register(PaymentBoardRequestPacket.class, "payment_board_request_packet", NetworkDirection.PLAY_TO_SERVER,
        ...
        register(PaymentBoardClaimPacket.class, "payment_board_claim_packet", NetworkDirection.PLAY_TO_SERVER,
                PaymentBoardClaimPacket::decode, PaymentBoardClaimPacket::encode, PaymentBoardClaimPacket::handle);
        ...
        register(PersonalStoragePacket.class, "personal_storage_packet", NetworkDirection.PLAY_TO_SERVER,
                PersonalStoragePacket::decode, PersonalStoragePacket::encode, PersonalStoragePacket::handle);

        register(PersonalStorageRequestPacket.class, "personal_storage_request_packet", NetworkDirection.PLAY_TO_SERVER,
        ...
        register(RequestTownDataPacket.class, "request_town_data_packet", NetworkDirection.PLAY_TO_SERVER,
                RequestTownDataPacket::decode, RequestTownDataPacket::encode, RequestTownDataPacket::handle);
        ...
        register(RefreshPlatformsPacket.class, "refresh_platforms_packet", NetworkDirection.PLAY_TO_CLIENT,
                RefreshPlatformsPacket::decode, RefreshPlatformsPacket::encode, RefreshPlatformsPacket::handle);

        register(RefreshDestinationsPacket.class, "refresh_destinations_packet", NetworkDirection.PLAY_TO_CLIENT,
                RefreshDestinationsPacket::decode, RefreshDestinationsPacket::encode,
                RefreshDestinationsPacket::handle);

        register(PlatformVisualizationPacket.class, "platform_visualization_packet", NetworkDirection.PLAY_TO_CLIENT,
                PlatformVisualizationPacket::decode, PlatformVisualizationPacket::encode,
                PlatformVisualizationPacket::handle);

        register(BoundarySyncResponsePacket.class, "boundary_sync_response_packet", NetworkDirection.PLAY_TO_CLIENT,
                BoundarySyncResponsePacket::decode, BoundarySyncResponsePacket::encode,
                BoundarySyncResponsePacket::handle);

        register(TownMapDataResponsePacket.class, "town_map_data_response_packet", NetworkDirection.PLAY_TO_CLIENT,
        ...
        register(PaymentBoardResponsePacket.class, "payment_board_response_packet", NetworkDirection.PLAY_TO_CLIENT,
                PaymentBoardResponsePacket::decode, PaymentBoardResponsePacket::encode,
                PaymentBoardResponsePacket::handle);

        register(BufferStorageResponsePacket.class, "buffer_storage_response_packet", NetworkDirection.PLAY_TO_CLIENT,
        ...
        register(TownDataResponsePacket.class, "town_data_response_packet", NetworkDirection.PLAY_TO_CLIENT,
                TownDataResponsePacket::decode, TownDataResponsePacket::encode, TownDataResponsePacket::handle);
