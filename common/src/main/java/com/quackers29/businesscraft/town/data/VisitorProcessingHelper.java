 ...
 * 
 * UNIFIED ARCHITECTURE: Platform-agnostic core with direct Minecraft API access.
 */
public class VisitorProcessingHelper {
    ...
    private void addBundledTouristReward(Town town, String originTownName, int payment, DistanceMilestoneHelper.MilestoneResult milestoneResult, int touristCount, long visitTimestamp) {
        ...
        try {
            ...
            // Create the bundled reward entry using unified payment board
            TownPaymentBoard paymentBoard = town.getPaymentBoard();
            UUID rewardId = null;
            
            if (paymentBoard != null) {
                rewardId = paymentBoard.addRewardWithTimestamp(
