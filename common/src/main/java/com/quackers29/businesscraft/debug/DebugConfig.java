...
public class DebugConfig {
    ...
    public static final boolean TOWN_INTERFACE_MENU = false; // Town name sync working correctly
    ...
    public static final boolean TOWN_DATA_SYSTEMS = false; // Town name sync implemented
