...
import com.yourdomain.businesscraft.town.data.SlotBasedStorage;
        ...
        client.execute(() -> {
            try {
                ...
                if (client.screen instanceof com.yourdomain.businesscraft.ui.screens.town.PaymentBoardScreen paymentScreen) {
                    ...
                    if (menu instanceof com.yourdomain.businesscraft.menu.PaymentBoardMenu) {
                        com.yourdomain.businesscraft.menu.PaymentBoardMenu paymentMenu = 
                            (com.yourdomain.businesscraft.menu.PaymentBoardMenu) menu;
