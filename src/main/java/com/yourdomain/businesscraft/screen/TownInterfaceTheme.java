...
public final class TownInterfaceTheme {
     ...
     */
    public static com.yourdomain.businesscraft.screen.components.BCTheme createBCTheme() {
        return com.yourdomain.businesscraft.screen.components.BCTheme.builder()
