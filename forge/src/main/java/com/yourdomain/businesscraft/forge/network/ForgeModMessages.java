package com.yourdomain.businesscraft.forge.network;
...
public class ForgeModMessages {
    ...
    public static void register() {
        ForgeNetworkHelper networkHelper = (ForgeNetworkHelper) com.yourdomain.businesscraft.forge.BusinessCraftForge.NETWORK;
