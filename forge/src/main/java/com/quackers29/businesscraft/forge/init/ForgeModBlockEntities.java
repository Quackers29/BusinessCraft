...
public class ForgeModBlockEntities {
    public static RegistryObject<BlockEntityType<ForgeTownInterfaceEntity>> TOWN_INTERFACE_ENTITY = ForgeRegistryHelper.BLOCK_ENTITY_TYPES.register("town_interface",
            () -> BlockEntityType.Builder.of(ForgeTownInterfaceEntity::new, ForgeModBlocks.TOWN_INTERFACE_BLOCK.get()).build(null));
