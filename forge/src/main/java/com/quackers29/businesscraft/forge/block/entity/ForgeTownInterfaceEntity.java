...
/**
 * Forge-specific extension of TownInterfaceEntity that properly overrides getCapability.
 * This bridges the platform-agnostic getCapability method to Forge's capability system.
 */
public class ForgeTownInterfaceEntity extends TownInterfaceEntity {
    ...
    public <T> LazyOptional<T> getCapability(@NotNull Capability<T> cap, @Nullable Direction side) {
        ...
        Object result = super.getCapability(cap, side);
