# v1.1 Task (Deferred from v1.0): Town Interface World Generation & Village Spawning

**Status**: Deferred past v1.0 (decision made June 2026 during v1 release-readiness review). Planning and exploration are complete; implementation has NOT started. The survival accessibility problem this was meant to solve is being addressed for v1 by enabling the Town Interface crafting recipe by default instead.
