...
- **[[Trade/Contracts/Bid Selection and Clamping|Bid Selection and Clamping]]** — each participating town can only raise (never lower) its own emerald offer on an open auction; when the timer expires the single highest of those standing offers wins and drives the handoff to courier or snail-mail delivery. (T-028)
