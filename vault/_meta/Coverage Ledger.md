...
| T-002 | Economy/Milestones/Distance Milestone Resolution | `town/data/DistanceMilestoneHelper.java` | TODO | `.../town/data/DistanceMilestoneHelperTest.java` | 2026-06-11 | RE-OPENED: McBootstrap unblocks the positive resolution path (ItemStack parse); extend the 8 existing guard tests |
| T-003 | Trade/Contracts/Auction Resolution | `contract/ContractBoard.java` | TODO | `.../contract/ContractBoardTest.java` | 2026-06-11 | RE-OPENED: McBootstrap may unblock courier cost happy path + closeAuctions (verify Town ctor); extend the 11 existing tests |
...
| T-007 | Town/Resources/Resource Storage Operations | `town/components/TownResources.java` + `TownEconomyComponent.java` | TODO | `.../town/components/TownResourcesTest.java` | 2026-06-11 | RE-OPENED: McBootstrap unblocks add/remove/overflow + NBT (Item construction); extend the 4 existing guard tests |
